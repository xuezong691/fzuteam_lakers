...
def query_record_by_id(record_id):
    ...
    try:
        ...
        if connection.is_connected():
            ...
            # 查询语句修改：表名events→things，字段id→num
...
def query_all_records():
    ...
    try:
        ...
        if connection.is_connected():
            ...
            # 查询语句修改：表名events→things，排序字段id→num
